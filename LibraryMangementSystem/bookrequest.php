              ...
              <div class="col-md-7">
                <div class="form-group">
                  ...
                  <select class="form-control" id="dept" name="dept">
                    ...
                    <option value="Textile Eng">Business Department</option>
                    <option value="Textile Eng">Applied Science</option>
                    <option value="Textile Eng">Communication Department</option>
                    <option value="Textile Eng">Law</option>
                  </select>
                  </div>
                </div>
              </div>
